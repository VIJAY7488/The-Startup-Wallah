...
const cards = [
  {
    id: 1,
    image:
      "https://res.cloudinary.com/dsdcta1sr/image/upload/v1739793466/Investor_sqou1w.jpg",
    title: "Marketing",
    description:
  ...
  },
  {
    id: 2,
    image:
      "https://res.cloudinary.com/dsdcta1sr/image/upload/v1739794030/businessman_xa1s8p.avif",
    title: "Sales",
    description:
  ...
  },
  {
    id: 3,
    image:
      "https://res.cloudinary.com/dsdcta1sr/image/upload/v1739793466/group_ywbyd6.jpg",
  ...
  return (
    <div className="bg-gray-100 px-4 sm:px-6 py-8 mt-[65px] ">
      ...
      <span className=" flex text-md mb-8  px-5  text-justify mt-4">
        ...
        empower. Discover real-world insights, proven strategies, and
        captivating success stories that turn everyday challenges into
        breakthrough opportunities. Whether you're looking to elevate your
        marketing, supercharge your sales, or ignite an entrepreneurial
        revolution, our resources are your trusted companions on the journey to
        transformative growth. Embrace these expert-driven, human-centered
        guides and let them become the spark that propels your
