...
const Companies = () => {
  return (
    <div className="flex flex-col items-center justify-center py-10 bg-white px-4 sm:px-6 lg:px-8" >
      <h2 
        className="text-black text-xl sm:text-2xl font-semibold mb-10 text-center">
        Backed by Industry Leaders & Visionary Investors: 
      </h2>

      <div className="overflow-hidden w-full relative max-w-screen mb-10">
        <motion.div 
          ...
          >
          {[...companies, ...companies].map((investor, index) => (
            <img
              key={index}
              src={investor.logo}
              alt={investor.name}
